<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header bg-black">
                <div class="row">
                    <div class="col-6"><label>Status Kesehatan</label></div>
                    <div class="col-6 text-right">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-5">Riwayat Imunisasi</div>
                    <div class="col-7">: </div>
                </div>
                <div class="row">
                    <div class="col-5">Riwayat Penyakit</div>
                    <div class="col-7">: </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-5">Lingkar Kepala</div>
                    <div class="col-7">: </div>
                </div>
                <div class="row">
